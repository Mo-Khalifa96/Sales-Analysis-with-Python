...
print('''As the line chart illustrates, the lower the price of a product, the higher the quantity
sold of that product, as in the case of batteries products. Meanwhile, the higher the price, 
the lower quantity sold, as in the case of laptops. Other than the obvious explanation that cheap 
products are more affordable, the trends in this dataset could be explained by the simple fact 
that highly priced products have higher longevity than low price products, and, relatedly, highly 
priced products tend to be less replaceable, are less replaceable and  thus the customer doesn't 
need to purchase them frequently compared to cheap but quickly exhaustible products.''')
print('')
